...
(echo n; echo p; echo 1; echo 139264; echo +64M; \
echo n; echo p; echo 2; echo ""; echo +2G; \
echo n; echo p; echo 3; echo ""; echo +2G; \
echo n; echo p; echo 4; echo ""; echo ""; \
echo w; echo q) | fdisk -w always -W always /dev/${disk_name} 

# 2
# Далеее накатываем файловую систему на размеченный диск.
echo "1. Создаем файловую систему ${disk_name}" 
