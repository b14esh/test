...
import (
	"20_package/rectangle"
	"fmt"
	//"github.com/b14esh/test/04_lesson_golang_next/20_package/rectangle"
)
...
func main() {
	...
	*/
	...
	newR := rectangle.Rectangle{
		A: 10,
		B: 7,
		//color: 12 // syntax error: unexpected newline in composite literal; possibly missing comma or }
	}
	fmt.Println(newR)
